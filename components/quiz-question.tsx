              ...
              {answers.map((answerText, i) => (
                <div key={i} className="flex items-center">
                  <input
                    ...
                    name="quiz-answer"
                    type="radio"
                    className="focus:ring-pink-500 h-4 w-4 text-pink-600 border-gray-300 peer disabled:cursor-not-allowed"
                    value={i}
                  ...
                  <label
                    htmlFor={i.toString()}
                    className="ml-3 block text-sm font-medium text-gray-200 peer-disabled:text-gray-500 peer-disabled:cursor-not-allowed"
                  >
                    {answerText}
